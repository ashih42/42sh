...
/*   Updated: 2018/03/18 06:07:21 by ashih            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					*ft_memccpy(void *dst, const void *isrc, int c,
									size_t n);
...
t_list					*ft_lst_new_ref(void const *content,
										size_t content_size);
...
void					ft_dl_lstdel(t_dl_list **alst,
							void (*del)(void *, size_t));
